...
- Tâche Python `print_hello`: Affiche un message simple.
...
**Commentaire :** La structure du DAG est claire et les tâches sont bien définies. Il pourrait être utile d'ajouter des descriptions plus détaillées pour chaque tâche afin de faciliter la compréhension.